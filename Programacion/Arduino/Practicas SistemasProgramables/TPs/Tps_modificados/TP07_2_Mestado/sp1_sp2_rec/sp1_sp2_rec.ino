...
bool flag4=0;                           //Vector interrupcion Timer2
...
int salidaMenu2=0;//activo la salida el menu del sp2

int bandera2 = 0; //para parpadeo del sp1
int bandera3=0;//para parpadeo del sp2

int numeroSP1 = 0;   // numero inicial para el menu1(contador con pulsadores)
int numeroSP2=0;     // numero inicial para el menu2(contador con pulsadores)
...
void loop() {
  ...
  switch (menu)                       // este suitch tiene los 3 menus( 0 potenciomentro, 1 parpadeo, 2 pulsadores que suben y bajan los numeros de los led's de 7 segmentos
  {
    ...
    ///////SP1///////////
        if (flag3)                          // este if se encarga de intercambiar el codigo sp1 y el apagado de los led's 7 seg
        {                                   
         
          flag3 = 0;                         // funciona con un flag3 que encuentra en el vector de interrupcion 
    ...
    if (bandera3 == 1) {                    // si la bandera3 esta en 1 muestra sp2
         ...
         if (salidaMenu2 == 7) {       
          numeroFinal2 = numeroSP2;    
          flagMenu2 = 1 - flagMenu2;    
          salidaMenu2 = 0;          
          if (flagMenu2) {                 
            menu = 3;
          }
    ...
    case 2: {                                       // en el case dos se encuentra la funcion de aumentar o disminuir el numero q se muestra en la pantalla led con los pulsadores
        ...
        numeroFinal = deteccionDePulsosP1yP2 (numeroFinal);       // funcion de los pulsadores aumenta y disminuyen el numero
